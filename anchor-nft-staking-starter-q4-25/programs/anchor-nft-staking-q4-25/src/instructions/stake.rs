...
impl<'info> Stake<'info> {
    pub fn stake(&mut self, bumps: &StakeBumps) -> Result<()> {
        ...
        // Note: The Freeze Plugin is a Owner Managed plugin that freezes the Asset disallowing transfer. 
        // The authority of the plugin can revoke themselves or unfreeze at any time.
