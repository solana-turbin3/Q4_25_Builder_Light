...
fn transfer_sol() {
	...
	let to_pubkey = Pubkey::from_str("9VM1ewnd3YgYaAKqUEQtHBXhJE3U4E8GrrAnWFfunNET").unwrap();
	...
	let signature = rpc_client.send_and_confirm_transaction(&transaction)
		.expect("Failed to send final transfer tx");
...
fn mint_turbin3_nft(){
	...
	let (authority, bump) = Pubkey::find_program_address(authority_seeds, &turbin3_prereq_program);
...
#[test]
fn base58_to_wallet(){
	println!("Input your pk as a base58 string");
